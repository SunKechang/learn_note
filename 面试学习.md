...
#### 查询日志的常用命令？
https://blog.csdn.net/qq_42405688/article/details/124978828
cat -n sys.log |tail -n +100|head -n 20
cat -n sys.log |grep "debug" |more
可以分页打印
...
### 存储
#### RAID等级
http://t.zoukankan.com/gomysql-p-3613767.html
